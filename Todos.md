...
- [x] An option to filter out 100% complete features with the intention of seeing what is left to complete when going through the feature list (so not hiding features with no estimates yet, just stuff that's actually finished)
