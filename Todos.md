...
- [x] **Overall Completion Hero Card - Legend Declutter**
...
- [x] **Burndown chart hero card X axis date overlap**
...
- [x] **Net Accessible Budget - add breakdown**
...
- [x] **Full-Team Budget Days Remaining - Calendar vs working days**
...
- [x] **Burndown chart — toggle to start from current date vs historical (on by default)**
...
- [x] **Burndown chart — Legend clarity**
