...
- [x] For remaining feature work in the Budget & spend, move the delivered amount to a new line instead of using a dot to separate it from the remaining % so that it is clearly cisually its own distinct data point. 
